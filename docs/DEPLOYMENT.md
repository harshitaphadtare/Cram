...
If you use Google/Microsoft sign-in, add the Vercel URL to Google's **Authorised JavaScript
origins** too (see `docs/AUTH-PROVIDERS.md`). The Supabase callback URL doesn't change.
